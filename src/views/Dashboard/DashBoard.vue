...
<dash-content v-for="items in contacts" :key="items.id">
  ...
  <p class="sub-header">Welcome To <span class="global"> Crypto Investment Limited. </span>

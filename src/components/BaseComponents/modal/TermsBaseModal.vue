<template>
  ...
  <dialog open>
    ...
    <p>Crypto Investment Limited ("Website"), which includes all products and services offered by Crypto Investment Limited,
      is and remains the sole property of the Company. All rights are reserved in and for the Company Crypto Investment Limited
      group is the owner of all the intellectual property rights, including trade names, trademarks, logos
      and the trade names in and are exclusive to Crypto Investment Limited at all times. Except where expressly stated
      ...
      any materials or media from the Website, without obtaining prior written permission from Crypto Investment Limited
      Group.</p>
    </div>
    <div>
      <h4>Data</h4>
    ...
    <div>
      <h4>Amendments</h4>
      <p>Crypto Investment Limited has the right to amend the Agreement without obtaining any prior consent from the Client.

    ...
    <form class="signUp" @submit.prevent="handleSubmit">
      <div class="wrapper">
        <div class="headline">
          <h1>SIGN UP</h1>
          <h2>
            Create New<span class="header-span"> Crypto Investment </span> Limited Account
          </h2>
          <p>
        ...
        <div class="form">
          <div class="signUp">
            ...
            <div class="form-group-3">
              <p class="form-group-3-para">Kindly upload the front of a Valid ID card for verification</p>
              <input type="file" accept="image/*"  required=""   />
              <br>
              <p class="form-group-3-para">Kindly upload the back of a Valid ID card for verification</p>
              <input type="file" accept="image/*"  required=""   />
            ...
            <div class="form-group-2">
              ...
              >I Agree To Crypto Investment Limited
